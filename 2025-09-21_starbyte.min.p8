...
if(n.e>130)n.f=0
if(rnd(1)<.01*f)add(h,{d=rnd(128),e=-10,o=0,f=1+rnd(.5),r=rnd(1)>.5,i=rnd{8,9},h=flr(rnd(f+1))})
if(j>3*f)add(c,{d=rnd(128),e=-10,f=.5})j=0
if(btn(0))l-=i/9
if(btn(1))l+=i/9
l*=.95e=max(3,min(e+l,128))if(btn(5)and r==0and i>0)add(o,{d=e,e=d-4,o=0,f=-2})r=20/f*2
for n in all(o)do n.d+=n.o n.e+=n.f if(n.e<0or n.e>128)del(o,n)
