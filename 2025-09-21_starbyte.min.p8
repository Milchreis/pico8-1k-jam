a=0n={e=-8,f=0,h=0}e=64d=118l=0i=.8f=1u=0o={}h={}s={}g={}r=0c={}j=0for n=1,40do add(g,{d=rnd(128),e=rnd(128)})end function b(n,e,d,f,i)return(n-d)^2+(e-f)^2<=i^2end function m()f=0k(e,d,12,4)if(f==0)i=0n.e=d-6n.h=flr(a)r=128
end function k(n,e,d,f)for f=1,5*f do p=sin(rnd()*6)add(s,{d=n,e=e,t=p*rnd(2,4),f=p*rnd(2,4),o=128,i=d})end end function _update60()if(btn(5)and i+r==0)run()
u=max(0,u-1)if i>0do a=t()*i if(a-10>n.h)n.e=-8n.f=i n.h=flr(a)else n.e+=n.f
if(rnd()<.01*f)add(h,{d=rnd(128),e=-10,t=0,f=1+rnd(.5),r=rnd()>.5,i=rnd{8,9},o=flr(rnd(f+1))})
if(j>f*f)add(c,{d=rnd(128),e=-10,f=.5})j=0
if(btn(0))l-=i/9
if(btn(1))l+=i/9
l*=.95e=max(3,min(e+l,128))if(btn(5)and u==0)for n=1,min(f,6)do add(o,{d=e+(n-(f+1)/2)*4,e=d-6,t=0,f=-2})u=60/f end
end for n in all(o)do n.d+=n.t n.e+=n.f if(n.e<0or n.e>128)del(o,n)
...
end for n in all(h)do circ(n.d,n.e,2,n.i)if(n.o>1)circ(n.d-3,n.e,1,n.i)circ(n.d+3,n.e,1,n.i)
if(n.o>2)line(n.d-3,n.e,n.d-5,n.e-2,n.i)line(n.d+3,n.e,n.d+5,n.e-2,n.i)
if(n.o>3)rect(n.d-1,n.e-4,n.d+1,n.e-2,n.i)
