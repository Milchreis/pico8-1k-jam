...
-- angle position for the rope rotation
angle=0

-- no. of stop frames after a collision
stp=0

-- no. of frame for camera shake
shake_fps=0
jump_fps=0

-- current level
cur_l=0
-- total time for current run
total_t=0

-- all enemies for the current level
e={}
